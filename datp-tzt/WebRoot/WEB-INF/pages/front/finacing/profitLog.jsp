...
.trade-amount .databtn {
	...
	<div class="container-full padding-top-30">
		<div class="container">
			...
			<div class="col-xs-12" style="margin:20px auto;padding-top:10px;background:#fff">
				<ul class="nav nav-tabs">
					<li ><a href="/finaWallet/view.html">持有中</a></li>
				<!-- 	<li ><a href="#">已结束的理财</a></li> -->
					<li ><a href="/web/buyRecord.html"> 交易记录</a> </li>
					<li class="active"><a
						href="/profitLog/websearch.html" >
						收益明细 </a></li>
				</ul>
			</div>
				...
				<div class="col-xs-7 col-xs-offset-5">
						<div class="form-group">
							<span>起始时间：</span> <input class="databtn datainput" 
								id="begindate" value="${tradeLog.beginTime }" readonly="readonly"></input>
							<span class="databtn datatips">—</span> <input
								class="databtn datainput" id="enddate" value="${tradeLog.endTime }"
								readonly="readonly"></input> <span>理财产品：</span> <input id="finaName"
								value="${tradeLog.finaName }"></input><button style="padding:1px 10px;" id="btnSearchProfitlog">搜索 </button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12"">
	...
	<script type="text/javascript"
		src="/static/front/js/finacing/profitLog.js"></script>
