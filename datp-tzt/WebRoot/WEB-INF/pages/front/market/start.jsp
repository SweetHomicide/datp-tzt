...
<link rel="stylesheet" href="/static/front/css/fullkline/fullScreenKline.css" type="text/css"></link>
</head>
<!-- Chart Container -->
	...
	<div id="chart_toolbar">
		...
		<div class="chart_dropdown" id="chart_dropdown_symbols" style="display:none;">
			<div class="chart_dropdown_t">
				<a>
					<span class="chart_str_btc_this_week">当周 ${fvirtualcointype.fShortName }</span>
					<span></span>
				</a>
			</div>
			<div class="chart_dropdown_data">
				<table>
				<c:forEach items="${allcoins }" var="v">
					<tr>
						<td>${v.fShortName }</td>
						<td>
							<ul id="chart_symbols_btc">
								<li>
									<a>
										<span class="chart_str_btc_this_week">当周 ${v.fShortName }</span>
										<span></span>
									</a>
								</li>
								<li>
									<a>
										<span class="chart_str_btc_next_week">次周 ${v.fShortName }</span>
										<span></span>
									</a>
								</li>
								<li>
									<a>
										<span class="chart_str_btc_month">全月 ${v.fShortName }</span>
										<span></span>
									</a>
								</li>
								<li>
									<a>
										<span class="chart_str_btc_quarter">季度 ${v.fShortName }</span>
										<span></span>
									</a>
								</li>
							</ul>
...
<c:forEach items="${allcoins }" var="v">
	<span name="chart_str_${v.fShortName}_this_week" zh_tw="當周 ${v.fShortName }" zh_cn="当周 ${v.fShortName }" en_us="${v.fShortName }" />
	<span name="chart_str_${v.fShortName}_next_week" zh_tw="次周 ${v.fShortName }" zh_cn="次周 ${v.fShortName }" en_us="${v.fShortName }" />
	<span name="chart_str_${v.fShortName}_month" zh_tw="全月 ${v.fShortName }" zh_cn="全月 ${v.fShortName }" en_us="${v.fShortName }" />
	<span name="chart_str_${v.fShortName}_quarter" zh_tw="季度 ${v.fShortName }" zh_cn="季度 ${v.fShortName }" en_us="${v.fShortName }" />
</c:forEach>
...
<script type="text/javascript" src="/static/front/js/fullkline/jquery.mousewheel.js"></script>
<script type="text/javascript" src="/static/front/js/fullkline/fullKilne.js"></script>
<script type="text/javascript">
	_set_current_language("zh-cn");
	_setCaptureMouseWheelDirectly(false);	
	_set_current_coinshortName('${fvirtualcointype.fShortName }');
	_set_current_coin('${fvirtualcointype.fid }');
	_set_current_contract_unit('${fvirtualcointype.fid }');
	onPushingStarted();
</script>
</html>