...
<link href="/static/front/css/kline_trade.css" rel=stylesheet type=text/css />
</head>
<body>
	<div class="main_box">
		<div class="k_img">
...
<script type="text/javascript" src="/static/front/js/newKline/jquery-1.8.2.js"></script>
<script type="text/javascript" src="/static/front/js/newKline/highstock.js"></script>
<script type="text/javascript" src="/static/front/js/newKline/exporting.js"></script>
<script src="/kline/trade_json.html?id=${param.id }"></script>
<script type="text/javascript" src="/static/front/js/newKline/kline_trade.js"></script>
