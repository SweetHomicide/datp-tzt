				...
				<div class="col-xs-12 padding-right-clear padding-left-clear rightarea user">
					<div class="col-xs-12 rightarea-con">
						<div class="user-top-icon">
							<h4> ${loginName}，您的账号安全级别${grade }</h4>
							<h5>${requestScope.constant['webName']}为您提供5重安全防护，实时保障您的资金和账户安全。</h5>
						</div>
							...
							<div class="panel">
								<div class="panel-header">
									<span class="panel-title">
										您已设置
										<span class="text-danger font-size-18"> ${bindType } </span>
										个保护项，还有
										<span class="text-danger font-size-18">${5-bindType } </span>
										个保护项可设置
									</span>
								</div>
											...
											<td class="col-xs-3 user-tr">
												...
												交易密码
                                                   ...
                                                   <c:choose>
													...
													<td class="col-xs-6 user-tr">
														<c:if test="${isTradePassword == false}">
															<c:if test="${isBindTelephone == false}">
																<span style="color:#c83935">请先绑定手机</span>
															</c:if>
															<c:if test="${isBindTelephone}">
																账户资金变动时，需先验证交易密码
															</c:if>
														</c:if>
														<c:if test="${isTradePassword }">
															账户资金变动时，需先验证交易密码
														</c:if>
													</td>
													<td class="col-xs-2 user-tr">
													<c:if test="${isTradePassword == false }">
														<c:if test="${isBindTelephone == true}">
					...
					<div class="modal-content">
						...
						<div class="modal-body form-horizontal">
							<div class="form-group unbindgoogle-hide-box" style="display:none">
								<div class="col-xs-6 col-xs-offset-4 clearfix">
							...
							<div class="form-group unbindgoogle-hide-box" style="display:none">
								<label for="unbindgoogle-key" class="col-xs-3 col-xs-offset-2 control-label">密匙</label>
								<div class="col-xs-6 ">
									<span id="unbindgoogle-key" class="form-control border-fff"></span>
								</div>
							</div>
							<div class="form-group unbindgoogle-hide-box" style="display:none">
								<label for="unbindgoogle-device" class="col-xs-3 col-xs-offset-2 control-label">设备名称</label>
								<div class="col-xs-6">
				...
				<div class="modal-dialog" role="document">
					...
					<div class="modal-content">
						...
						<div class="modal-body form-horizontal">
								...
								<span style="float:right;color:red; margin-top:7px;">*如需帮助请联系客服</span>
