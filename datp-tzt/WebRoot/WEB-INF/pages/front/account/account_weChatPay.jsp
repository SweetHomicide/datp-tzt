			...
			<div
				...
				<div class="col-xs-12 rightarea-con">
					<ul class="nav nav-tabs rightarea-tabs">
						<li class="active"><a href="/account/rechargeCny.html?type=1">人民币充值</a></li>
							...
							<div class="col-xs-12 padding-clear padding-top-30">
								<div class="col-xs-7">
									<form role="form" class="form-horizontal" method="post"
										action="/account/weChatPayGetQR.html">
										...
										<div class="form-group ">
												...
												<div class="col-xs-6">
													<select class="form-control" id="rechargeTypeweChatPay">
														<option value="">
															人民币
															</option>
										...
										<div class="form-group " id="divTxnAmt">
											...
											<div class="col-xs-6">
												<input id="txnAmt" class="form-control" type="number" min="1"
													name="txnAmt" placeholder="支付金额，单位为（分）" value=""
													title="单位为分,不能带小数点 " required="required"  onkeyup="checkleng(this)"/>
											</div>
										</div>
										...
										<div class="form-group ">
											...
											<div class="col-xs-6">
												...
												<button type="button" class="btn btn-danger btn-block"
												style="display: none"	data-target="#withdrawQR" id="ShowQR" data-toggle="modal">继续充值</button>
											</div>
										</div>
									</form>
...
<div class="modal modal-custom fade" id="withdrawQR" tabindex="-1"
	...
	<script>
		...
		$(function() {
			$("#btn_pay").click(
					function() {
						var rechargeType=$('#rechargeTypeweChatPay option:selected').val();//选中的值
						...
						var url = "/account/weChatPayGetQR.html?random="
		...
		function OrderQuery(tradeno) {
			var url = "/account/weChatPayQuery.html?random="
					+ Math.round(Math.random() * 100);
			$.post(url, {
