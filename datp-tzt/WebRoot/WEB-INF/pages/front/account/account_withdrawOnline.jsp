<%@ page language="java" import="java.util.*"  import="java.text.SimpleDateFormat"
pageEncoding="UTF-8"%>
			...
			<div class="col-xs-10 padding-right-clear">
				<div class="col-xs-12 padding-right-clear padding-left-clear rightarea withdraw recharge">
					<div class="col-xs-12 rightarea-con">
						...
						<div class="col-xs-12 padding-clear padding-top-30">
							<div class="col-xs-7 padding-clear form-horizontal" id="draw_form">
							    <div class="form-group ">
									<label for="withdrawAmount" class="col-xs-3 control-label">账户余额</label>
									<div class="col-xs-6">
										<span class="form-control border-fff">￥<fmt:formatNumber value="${requestScope.fwallet.ftotalRmb }" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="4"/></span>
									</div>
								</div>
								<%-- <div class="form-group ">
									<label for="orderId" class="col-xs-3 control-label">支付编号：</label>
									<div class="col-xs-6">
										<input id="orderId" class="form-control" type="hidden"
														name="orderId" placeholder="支付编号" readonly="readonly"
														value="${login_user.getFid()}<%=new SimpleDateFormat("yyyyMMddHHmmss").format(new Date())%>"
								...
								<div class="form-group ">
									...
									<div class="col-xs-6">
										<input id="withdrawBalance" class="form-control" type="text" value="">
							...
							<c:if test="${isBindGoogle ==true}">	
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<button id="withdrawOnlineButton" class="btn btn-danger btn-block">立即提现</button>
									</div>
								</div>
							</div>
							
							<div class="col-xs-7 padding-clear form-horizontal" id="result_form" hidden="hidden">
								<span class="rechare-success">
											<span class="success-icon"  id="withdraw_result"></span>
											</br>
											<span class="success-icon"  id="withdraw_id"></span>
											<a href="/account/withdrawOnline.html?type=0">继续充值 >></a>
											<p></p>
										</span>
							</div>
							<div class="col-xs-12 padding-clear padding-top-30">
								<div class="panel panel-tips">
									...
									<div class="panel-body">
										...
										<p>&lt 每天最多提现五次</p>
										<p>&lt 提现时会收取一定的手续费。</p>
										<p>&lt 正常5分钟内到账，具体到账时间因收款银行略有不同，节假日到账时间略有延迟。</p>
...
<%@include file="../comm/footer.jsp" %>	
	...
	<script type="text/javascript" src="/static/front/js/finance/account.withdraw2.js"></script>
