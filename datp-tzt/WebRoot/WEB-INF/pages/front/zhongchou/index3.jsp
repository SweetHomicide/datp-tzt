...
<body>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<c:if test="${fsubscriptions.size()==0}">
							<span
								style="margin-top: 10px; line-height: 100px; font-size: 17px;">暂无数据</span>
						</c:if>
						<div class="col-xs-12">
	...
	$("#test").on("click", function() {
		...
		$.ajax({
			type:"POST",
			url:"/appApi.html",
			//data:{action:"GetZhongChouResource",fid:"402880c959b6cf2a0159b9916da669d3"},
			//data:{action:"GetZhongChouList",type:2,currentPage:1},
			//data:{action:"GetZhongChouLogs",currentPage:1},
			data:{action:"nowCrowd",fid:"402880c959b6cf2a0159b9916da669d3",buyAmount:"100",pwd:"jq390813"},
