				...
				<ul class="orderlist">
					<li style="height:31px;">
						<span style="float:left;padding-left:15px;">
							 ...
							 <span class="lightorange1 fontsize"><fmt:formatNumber value="${LatestDealPrize }" pattern="##.##" maxFractionDigits="4" maxIntegerDigits="10"/></span>
						</span>
