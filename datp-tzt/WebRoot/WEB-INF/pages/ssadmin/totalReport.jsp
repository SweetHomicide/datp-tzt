...
<body>
	<div class="pageFormContent" layoutH="20">
		...
		<fieldset>
			...
			<dl>
				<dt style="width: 145px;">今日${v.key }充值金额：</dt>
				<dd style="color:red;font-weight:bold;">
			 ...
			 <%-- <dl>
				<dt>今日充值码金额：</dt>
				<dd style="color:red;font-weight:bold;">
					<span class="unit">${todayCodeAmt}</span>
				</dd>
			</dl> --%>
			<c:forEach items="${totalAmountInMap }" var="v">
			<dl>
				<dt style="width: 145px;">累计${v.key }充值金额：</dt>
				<dd style="color:red;font-weight:bold;">
					<span class="unit">${v.value}</span>
				</dd>
			</dl>
			...
			<%-- <dl>
				<dt>累计充值码金额：</dt>
				<dd style="color:red;font-weight:bold;">
					<span class="unit">${totalCodeAmt}</span>
				</dd>
			</dl> --%>
		</fieldset>
			...
			<dl>
				...
				<dd style="color:red;font-weight:bold;">
					<span class="unit"><fmt:formatNumber
							value="${wallet.totalRmb}" pattern="#0.######" /> </span>
				</dd>
			</dl>
			<dl>
				<dt>含冻结金额：</dt>
				<dd style="color:red;font-weight:bold;">
					<span class="unit"><fmt:formatNumber
							value="${wallet.frozenRmb}" pattern="#0.######" /> </span>
				</dd>
			</dl>
