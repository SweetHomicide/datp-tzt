		...
		<input type="hidden" name="fid" value="${virtualCoinType.fid}"/>
			<c:forEach items="${allFees}" var="fee">
				<dl>
					<dt>
						等级[ <b><font color="red"><fmt:formatNumber
									value="${fee.flevel}" pattern="#0.######" /> </font> </b> ]卖方交易手续费：
					</dt>
					<dd>
				...
				<dl>
					<dt>
						等级[ <b><font color="red"><fmt:formatNumber
									value="${fee.flevel}" pattern="#0.######" /> </font> </b> ]买方交易手续费：
					</dt>
					<dd>
				...
				<dl>
					<dt>
						等级[ <b><font color="red"><fmt:formatNumber
									value="${fee.flevel}" pattern="#0.######" /> </font> </b>]提现手续费：
					</dt>
					<dd>
						<input type="text" name="withdraw${fee.fid}"
							value="<fmt:formatNumber
