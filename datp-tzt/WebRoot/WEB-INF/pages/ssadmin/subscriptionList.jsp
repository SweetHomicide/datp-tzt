		...
		<tbody>
			<c:forEach items="${subscriptionList}" var="subscription"
				...
				<tr target="sid_user" rel="${subscription.fid}">
					...
					<td><fmt:formatNumber value="${subscription.ftotal}" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="6" /></td>
					<td><fmt:formatNumber value="${subscription.fAlreadyByCount}" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="6" /></td>
