			...
			<dl>
				...
				<dd>
					<input type="text" name="fbuyCount" class="required digits"
						value="<fmt:formatNumber value="${subscription.fbuyCount}" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="4"/>" /><span>0为无限</span>
				</dd>
			</dl>
			<dl>
				<dt>每人最多回购次数：</dt>
				<dd>
					<input type="text" name="fbuyTimes" class="required digits"
						value="<fmt:formatNumber value="${subscription.fbuyTimes}" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="4"/>" /><span>0为无限</span>
				</dd>
			</dl>
			<dl>
				<dt>开始时间：</dt>
