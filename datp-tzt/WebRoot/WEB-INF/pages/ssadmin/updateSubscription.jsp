		...
		<div class="pageFormContent nowrap" layoutH="97">
		 <dl>
			...
			<dl>
				...
				<dd>
					<c:choose>
						<c:when test="${subscription.fisRMB}">
							<input type="checkbox" name="fisRMB" checked='1' />
						</c:when>
						<c:otherwise>
			...
			<dl>
				...
				<dd>
					<input type="text" name="ftotal" class="required number"
						value="<fmt:formatNumber value="${subscription.ftotal}" pattern="##.##" maxIntegerDigits="10" maxFractionDigits="6" />" />
				</dd>
			</dl>
			<dl>
				<dt>兑换价格：</dt>
				<dd>
					<input type="text" name="fprice" class="required number"
						value="${subscription.fprice}"  onkeyup="checkNum(this)"/>
				</dd>
			</dl>
			<dl>
				<dt>每人最大兑换数量：</dt>
