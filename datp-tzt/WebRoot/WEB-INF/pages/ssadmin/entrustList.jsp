		...
		<div class="searchBar">
			...
			<table class="searchContent">
				<tr>
					...
					<td>开始结束： <input type="text" name="logDate1" class="date"
	...
	<div class="panelBar">
		<div class="pages">
			<span>总共: ${totalCount}条；
			 查询区间总成交数量：<font color="red">${totalAmt }</font>; 
			 查询区间总成交金额：<font color="red">${totalQty }</font>;
			  查询区间总手续费：<font color="red">${fees }</font>;</span>
		</div>
