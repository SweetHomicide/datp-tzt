...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/auditUser1.html">
				<li><a class="edit"
					href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/auditUser"
					target="dialog" rel=auditUser height="400" width="800"><span>审核</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/auditUser2.html">	
			<li><a title="确实要审核这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="ssadmin/auditUserALL.html?type=1"
				class="edit"><span>全部审核通过</span> </a>
			</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/auditUser3.html">
			<li><a title="确实要审核这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="ssadmin/auditUserALL.html?type=2"
