	...
	<form method="post" action="ssadmin/updateSharePlan.html"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				<dt>分红总金额：</dt>
				<dd>
					<input type="text" name="famount" class="required number" value="${shareplan.famount }"/>
				</dd>
			</dl>
			<dl>
				<dt>有效开始日期：</dt>
...
<%-- 			<dl>
				<dt>分红比例：</dt>
				<dd>
					<input type="text" name="fpercent" class="required number"  value="${shareplan.fpercent }"/><span
						class="info">%</span>
				</dd>
			</dl> --%>
		</div>
