...
<head>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        .btn-group button{outline:0;font-size:.24rem;color:#9b9ea7;background-color: #1f222b;border:1px solid #2a2d36;width: 16.66666%; }
        .btn-group button.btn-success{
            background-color: #292c35;color:#fff;}
    </style>
</head>
<body style="background-color: #1f222b;">
<div id="chart-control" class="btn-group" data="${fvirtualcointype.fid }"  style="width:95%;margin:.21rem auto;height:.64rem;">
    <button data-time='5m' data-n="1" class="btn">5分钟</button>
    ...
    <button data-time="8h" data-n="5" class="btn  btn-success">6小时</button>
    <button data-time="1d" data-n="5" class="btn">日线</button>
</div>
<div id="fname" data="${fvirtualcointype.fShortName}"></div>
...
<div style="width: 6.4rem;" id="depth"></div>
<script>
    document.write('<s'+'cript  src="/real/appperiod.html?symbol='+$("#chart-control").attr('data')+'&fShortName='+$("#fname").attr('data')+'&t='+Math.random()+'"></scr'+'ipt>');
    document.write('<s'+'cript async src="/static/app/app_kline/highcharts-custom.js?t=1"></scr'+'ipt>');
    initRem();
