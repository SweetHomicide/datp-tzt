...
public class CountLimitController extends BaseController {
	...
	public ModelAndView Index() throws Exception{
		...
		filter.append("and ((ftype="+CountLimitTypeEnum.AdminLogin+" and fcount >= "+Constant.ErrorCountAdminLimit+") \n");
		filter.append("or (ftype <>"+CountLimitTypeEnum.AdminLogin+" and fcount >= "+Constant.ErrorCountLimit+")) \n");
