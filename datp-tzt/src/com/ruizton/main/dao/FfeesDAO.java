...
/**
 	* A data access object (DAO) providing persistence and search support for Ffees entities.
...
public class FfeesDAO extends HibernateDaoSupport  {
    ...
    public Ffees findById( java.lang.Integer id) {
        ...
        try {
            Ffees instance = (Ffees) getSession()
                    .get("com.ruizton.main.model.Ffees", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Ffees> findByExample(Ffees instance) {
        ...
        try {
            List<Ffees> results = (List<Ffees>) getSession()
                    .createCriteria("com.ruizton.main.model.Ffees")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Ffees instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Ffees as model where model." 
         						+ propertyName + "= ?";
	...
	public Ffees findFfee(String virtualCoinType,int level) {
		...
		try {
			String queryString = "from Ffees where fvirtualcointype.fid="+"'"+virtualCoinType+"'" +"and flevel=?";
	         Query queryObject = getSession().createQuery(queryString);
