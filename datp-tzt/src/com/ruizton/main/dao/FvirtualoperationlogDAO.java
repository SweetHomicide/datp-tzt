...
public class FvirtualoperationlogDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(FvirtualoperationlogDAO.class);
	// property constants
	...
	public List<Fvirtualoperationlog> findByExample(
			Fvirtualoperationlog instance) {
		log.debug("finding Fvirtualoperationlog instance by example");
		try {
			List<Fvirtualoperationlog> results = (List<Fvirtualoperationlog>) getSession()
					.createCriteria(
							"com.ruizton.main.model.Fvirtualoperationlog")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fvirtualoperationlog instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Fvirtualoperationlog as model where model."
					+ propertyName + "= ?";
	...
	public Fvirtualoperationlog merge(Fvirtualoperationlog detachedInstance) {
		...
		try {
			Fvirtualoperationlog result = (Fvirtualoperationlog) getSession()
