...
/**
 	* A data access object (DAO) providing persistence and search support for Fwebbaseinfo entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.ruizton.main.model.Fwebbaseinfo
...
public class FwebbaseinfoDAO extends HibernateDaoSupport  {
    ...
    public Fwebbaseinfo findById( java.lang.String id) {
        log.debug("getting Fwebbaseinfo instance with id: " + id);
        try {
            Fwebbaseinfo instance = (Fwebbaseinfo) getSession()
                    .get("com.ruizton.main.model.Fwebbaseinfo", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fwebbaseinfo> findByExample(Fwebbaseinfo instance) {
        ...
        try {
            List<Fwebbaseinfo> results = (List<Fwebbaseinfo>) getSession()
                    .createCriteria("com.ruizton.main.model.Fwebbaseinfo")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fwebbaseinfo instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fwebbaseinfo as model where model." 
         						+ propertyName + "= ?";
    ...
    public Fwebbaseinfo merge(Fwebbaseinfo detachedInstance) {
        ...
        try {
            Fwebbaseinfo result = (Fwebbaseinfo) getSession()
