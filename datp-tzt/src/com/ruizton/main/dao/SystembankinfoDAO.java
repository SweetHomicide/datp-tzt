...
/**
 	* A data access object (DAO) providing persistence and search support for Systembankinfo entities.
...
public class SystembankinfoDAO extends HibernateDaoSupport  {
    ...
    public Systembankinfo findById( java.lang.String id) {
        log.debug("getting Systembankinfo instance with id: " + id);
        try {
            Systembankinfo instance = (Systembankinfo) getSession()
                    .get("com.ruizton.main.model.Systembankinfo", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Systembankinfo> findByExample(Systembankinfo instance) {
        ...
        try {
            List<Systembankinfo> results = (List<Systembankinfo>) getSession()
                    .createCriteria("com.ruizton.main.model.Systembankinfo")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Systembankinfo instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Systembankinfo as model where model." 
         						+ propertyName + "= ? order by model.fcreateTime desc";
    ...
    public Systembankinfo merge(Systembankinfo detachedInstance) {
        ...
        try {
            Systembankinfo result = (Systembankinfo) getSession()
	...
	public List<Systembankinfo> list(int firstResult, int maxResults,
