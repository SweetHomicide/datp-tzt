...
/**
 	* A data access object (DAO) providing persistence and search support for Foperationlog entities.
...
public class FoperationlogDAO extends HibernateDaoSupport  {
    ...
    public Foperationlog findById( java.lang.String id) {
        log.debug("getting Foperationlog instance with id: " + id);
        try {
            Foperationlog instance = (Foperationlog) getSession()
                    .get("com.ruizton.main.model.Foperationlog", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Foperationlog> findByExample(Foperationlog instance) {
        ...
        try {
            List<Foperationlog> results = (List<Foperationlog>) getSession()
                    .createCriteria("com.ruizton.main.model.Foperationlog")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Foperationlog instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Foperationlog as model where model." 
         						+ propertyName + "= ?";
    ...
    public Foperationlog merge(Foperationlog detachedInstance) {
        ...
        try {
            Foperationlog result = (Foperationlog) getSession()
