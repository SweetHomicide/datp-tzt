...
public class FautotradeDAO extends HibernateDaoSupport {
	...
	public Fautotrade findById(java.lang.String id) {
		log.debug("getting Fautotrade instance with id: " + id);
		try {
			Fautotrade instance = (Fautotrade) getSession().get(
					"com.ruizton.main.model.Fautotrade", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fautotrade> findByExample(Fautotrade instance) {
		...
		try {
			List<Fautotrade> results = (List<Fautotrade>) getSession()
					.createCriteria("com.ruizton.main.model.Fautotrade")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fautotrade instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fautotrade as model where model."
					+ propertyName + "= ?";
	...
	public Fautotrade merge(Fautotrade detachedInstance) {
		...
		try {
			Fautotrade result = (Fautotrade) getSession().merge(
					detachedInstance);
