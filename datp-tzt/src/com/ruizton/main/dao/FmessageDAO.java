...
public class FmessageDAO extends HibernateDaoSupport {
	...
	public Fmessage findById(java.lang.Integer id) {
		...
		try {
			Fmessage instance = (Fmessage) getSession().get("com.ruizton.main.model.Fmessage", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fmessage> findByExample(Fmessage instance) {
		...
		try {
			List<Fmessage> results = (List<Fmessage>) getSession()
					.createCriteria("com.ruizton.main.model.Fmessage").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fmessage instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fmessage as model where model."
					+ propertyName + "= ?";
