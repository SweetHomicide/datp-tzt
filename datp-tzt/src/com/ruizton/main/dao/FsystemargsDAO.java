...
public class FsystemargsDAO extends HibernateDaoSupport {
	...
	public Fsystemargs findById(java.lang.String id) {
		log.debug("getting Fsystemargs instance with id: " + id);
		try {
			Fsystemargs instance = (Fsystemargs) getSession().get(
					"com.ruizton.main.model.Fsystemargs", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Fsystemargs> findByExample(Fsystemargs instance) {
		...
		try {
			List<Fsystemargs> results = (List<Fsystemargs>) getSession()
					.createCriteria("com.ruizton.main.model.Fsystemargs").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Fsystemargs instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Fsystemargs as model where model."
					+ propertyName + "=?";
	...
	public Fsystemargs merge(Fsystemargs detachedInstance) {
		...
		try {
			Fsystemargs result = (Fsystemargs) getSession().merge(
					detachedInstance);
