...
public class FarticletypeDAO extends HibernateDaoSupport {
	...
	public Farticletype findById(java.lang.String id) {
		log.debug("getting Farticletype instance with id: " + id);
		try {
			Farticletype instance = (Farticletype) getSession().get(
					"com.ruizton.main.model.Farticletype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Farticletype> findByExample(Farticletype instance) {
		...
		try {
			List<Farticletype> results = (List<Farticletype>) getSession()
					.createCriteria("com.ruizton.main.model.Farticletype").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Farticletype instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Farticletype as model where model."
					+ propertyName + "= ?";
	...
	public Farticletype merge(Farticletype detachedInstance) {
		...
		try {
			Farticletype result = (Farticletype) getSession().merge(
					detachedInstance);
