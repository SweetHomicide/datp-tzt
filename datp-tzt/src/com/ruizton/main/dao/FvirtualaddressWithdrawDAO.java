...
public class FvirtualaddressWithdrawDAO extends HibernateDaoSupport {
	...
	public FvirtualaddressWithdraw findById(java.lang.String id) {
		...
		try {
			FvirtualaddressWithdraw instance = (FvirtualaddressWithdraw) getSession()
					.get("com.ruizton.main.model.FvirtualaddressWithdraw", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<FvirtualaddressWithdraw> findByExample(
		...
		try {
			List<FvirtualaddressWithdraw> results = (List<FvirtualaddressWithdraw>) getSession()
					.createCriteria("com.ruizton.main.model.FvirtualaddressWithdraw")
	...
	public FvirtualaddressWithdraw findByAddAndUid(String fid, String withdrawAddr) {
		...
		log.debug("finding FvirtualaddressWithdraw instance with filter");
		try {
			String queryString = "from FvirtualaddressWithdraw where fadderess='"+withdrawAddr+"' and fuser ='"+fid+"'";
			Query queryObject = getSession().createQuery(queryString);
