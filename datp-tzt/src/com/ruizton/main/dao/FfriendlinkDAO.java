...
public class FfriendlinkDAO extends HibernateDaoSupport {
	...
	public Ffriendlink findById(java.lang.String id) {
		log.debug("getting Ffriendlink instance with id: " + id);
		try {
			Ffriendlink instance = (Ffriendlink) getSession().get(
					"com.ruizton.main.model.Ffriendlink", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Ffriendlink> findByExample(Ffriendlink instance) {
		...
		try {
			List<Ffriendlink> results = (List<Ffriendlink>) getSession()
					.createCriteria("com.ruizcon.main.model.Ffriendlink").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Ffriendlink instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Ffriendlink as model where model."
					+ propertyName + "= ?";
	...
	public Ffriendlink merge(Ffriendlink detachedInstance) {
		...
		try {
			Ffriendlink result = (Ffriendlink) getSession().merge(
					detachedInstance);
