...
/**
 	* A data access object (DAO) providing persistence and search support for Fbankinfo entities.
...
public class FbankinfoDAO extends HibernateDaoSupport  {
    ...
    public Fbankinfo findById( java.lang.Integer id) {
        ...
        try {
            Fbankinfo instance = (Fbankinfo) getSession()
                    .get("com.ruizton.main.model.Fbankinfo", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fbankinfo> findByExample(Fbankinfo instance) {
        ...
        try {
            List<Fbankinfo> results = (List<Fbankinfo>) getSession()
                    .createCriteria("com.ruizton.main.model.Fbankinfo")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fbankinfo instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fbankinfo as model where model." 
         						+ propertyName + "= ?";
    ...
    public Fbankinfo merge(Fbankinfo detachedInstance) {
        ...
        try {
            Fbankinfo result = (Fbankinfo) getSession()
    ...
    public Fbankinfo findUserBankInfo(String fid){
