...
/**
 	* A data access object (DAO) providing persistence and search support for Fwithdrawfees entities.
...
public class FwithdrawfeesDAO extends HibernateDaoSupport  {
    ...
    public Fwithdrawfees findById( java.lang.String id) {
        log.debug("getting Fwithdrawfees instance with id: " + id);
        try {
            Fwithdrawfees instance = (Fwithdrawfees) getSession()
                    .get("com.ruizton.main.model.Fwithdrawfees", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fwithdrawfees> findByExample(Fwithdrawfees instance) {
        ...
        try {
            List<Fwithdrawfees> results = (List<Fwithdrawfees>) getSession()
                    .createCriteria("com.ruizton.main.model.Fwithdrawfees")
                    .add( create(instance) )
            .list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Fwithdrawfees instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Fwithdrawfees as model where model." 
         						+ propertyName + "= ?";
    ...
    public Fwithdrawfees merge(Fwithdrawfees detachedInstance) {
        ...
        try {
            Fwithdrawfees result = (Fwithdrawfees) getSession()
