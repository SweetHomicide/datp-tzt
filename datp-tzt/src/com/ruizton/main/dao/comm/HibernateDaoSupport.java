...
package com.ruizton.main.dao.comm;
...
public abstract class HibernateDaoSupport extends DaoSupport {
	...
	private static final Logger log = LoggerFactory.getLogger(HibernateDaoSupport.class);
...
//	  this.hibernateTemplate.setCacheQueries(true) ;//fake hank
	...
	public List findByParam(int firstResult, int maxResults, String filter,boolean isFY,String CLASS,Object... param) {
		List list = null;
	...
	public int executeSQL(String sql) {
		...
		try {
			...
			count = queryObject.executeUpdate() ;
		} catch (RuntimeException re) {
			log.error("execute sql failed", re);
			throw re;
		}
		return count ;
	}
