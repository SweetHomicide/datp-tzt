...
public class FrontValidateService extends BaseService{
	...
	//用户注册邮件验证
	public boolean updateMailValidate(String uid,String uuid) throws Exception{
		boolean flag = false ;
		try{
	...
	//找回密码邮件
	public Emailvalidate updateFindPasswordMailValidate(String uid,String uuid) throws Exception{
	...
	public Fvalidatemessage findFvalidateMessageById(String id){
	...
	public Fvalidateemail findValidateMailsById(String id){
