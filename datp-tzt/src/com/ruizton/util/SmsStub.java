...
public class SmsStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService("Sms"
				+ getUniqueSuffix());
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "replyConfirm"));
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "auditing"));
		_service.addOperation(__operation);
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "report"));
		_service.addOperation(__operation);
	 ...
	 */
	public SmsStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
	 ...
	 * @param replyConfirmRequest0
	 */

	public SmsStub.ReplyConfirmResponse replyConfirm(

	SmsStub.ReplyConfirmRequest replyConfirmRequest0)
...

	{
		...
		try {
			...
			_operationClient
					.getOptions()
					.setAction(
							"http://ws.flaginfo.com.cn/SmsPortType/ReplyConfirmRequest");
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					.getSoapVersionURI()), replyConfirmRequest0,
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(), SmsStub.ReplyConfirmResponse.class,
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultreplyConfirm((SmsStub.ReplyConfirmResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback.receiveErrorreplyConfirm(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	 ...
	 * 
	 * @see Sms#auditing
	 * @param auditingRequest2
	 */

	public SmsStub.AuditingResponse auditing(

	SmsStub.AuditingRequest auditingRequest2)
...

	{
		...
		try {
			...
			_operationClient.getOptions().setAction(
					"http://ws.flaginfo.com.cn/SmsPortType/AuditingRequest");
			_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(
					true);
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					.getSoapVersionURI()), auditingRequest2,
					optimizeContent(new javax.xml.namespace.QName(
							"http://ws.flaginfo.com.cn", "auditing")));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(), SmsStub.AuditingResponse.class,
					getEnvelopeNamespaces(_returnEnv));
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(resultEnv
									...
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultauditing((SmsStub.AuditingResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback.receiveErrorauditing(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
										// we cannot intantiate the class -
										// throw the
...

	{
		...
		try {
			...
			_operationClient.getOptions().setAction(
					"http://ws.flaginfo.com.cn/SmsPortType/ReportRequest");
			_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(
					true);
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(), SmsStub.ReportResponse.class,
					getEnvelopeNamespaces(_returnEnv));
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(resultEnv
									...
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultreport((SmsStub.ReportResponse) object);
	...
	SmsStub.ReplyRequest replyRequest6)
...

	{
		...
		try {
			...
			_operationClient.getOptions().setAction(
					"http://ws.flaginfo.com.cn/SmsPortType/ReplyRequest");
			_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(
					true);
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					.getSoapVersionURI()), replyRequest6,
					optimizeContent(new javax.xml.namespace.QName(
							"http://ws.flaginfo.com.cn", "reply")));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(), SmsStub.ReplyResponse.class,
					getEnvelopeNamespaces(_returnEnv));
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(resultEnv
									...
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultreply((SmsStub.ReplyResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback.receiveErrorreply(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
										// we cannot intantiate the class -
										// throw the
...

	{
		...
		try {
			...
			_operationClient.getOptions().setAction(
					"http://ws.flaginfo.com.cn/SmsPortType/SmsRequest");
			_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(
					true);
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(), SmsStub.SmsResponse.class,
					getEnvelopeNamespaces(_returnEnv));
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback.receiveErrorsms(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
										// we cannot intantiate the class -
										// throw the
	...
	// http://112.65.228.88:8888/sms_hb/services/Sms/
	public static class ReplyConfirmResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "ReplyConfirmResponse", "ns1");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
					...
					ReplyConfirmResponse.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":ReplyConfirmResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ReplyConfirmResponse", xmlWriter);
				}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			elementList.add(new javax.xml.namespace.QName(
					"http://ws.flaginfo.com.cn", "result"));
		...
		public static class Factory {
			 ...
			 */
			public static ReplyConfirmResponse parse(
					javax.xml.stream.XMLStreamReader reader)
							...
							if (!"ReplyConfirmResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ReplyConfirmResponse) ExtensionMapper
	...
	public static class ReplyRequest implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "ReplyRequest", "ns1");
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":ReplyRequest",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ReplyRequest", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ReplyRequest parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"ReplyRequest".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ReplyRequest) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn1(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn2(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn3(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
	...
	public static class Report implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "Report", "ns1");
	...
	public static class AuditingResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "AuditingResponse", "ns1");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					AuditingResponse.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":AuditingResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "AuditingResponse", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static AuditingResponse parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
						...
						if (fullTypeName != null) {
							...
							if (!"AuditingResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (AuditingResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class ReplyConfirmRequest implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "ReplyConfirmRequest", "ns1");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					ReplyConfirmRequest.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":ReplyConfirmRequest",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ReplyConfirmRequest", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ReplyConfirmRequest parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"ReplyConfirmRequest".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ReplyConfirmRequest) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn4(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
	...
	public static class SmsResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "SmsResponse", "ns1");
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":SmsResponse", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "SmsResponse", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static SmsResponse parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
						...
						if (fullTypeName != null) {
							...
							if (!"SmsResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (SmsResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class Sms implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "Sms", "ns1");
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":Sms", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "Sms", xmlWriter);
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static Sms parse(javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				Sms object = new Sms();
				...
				try {
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn5(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn6(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn7(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setIn8(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
	...
	public static class AuditingRequest implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "AuditingRequest", "ns1");
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":AuditingRequest",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "AuditingRequest", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static AuditingRequest parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
						...
						if (fullTypeName != null) {
							...
							if (!"AuditingRequest".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (AuditingRequest) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class Reply implements org.apache.axis2.databinding.ADBBean {
		 ...
		 * Reply Namespace URI = http://ws.flaginfo.com.cn Namespace Prefix =
		 * ns1
		 */
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":Reply", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "Reply", xmlWriter);
				}
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter
							.writeStartElement(prefix, "reply_time", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			elementList.add(new javax.xml.namespace.QName(
					"http://ws.flaginfo.com.cn", "callMdn"));
			...
			elementList.add(new javax.xml.namespace.QName(
					"http://ws.flaginfo.com.cn", "content"));
			...
			elementList.add(new javax.xml.namespace.QName(
					"http://ws.flaginfo.com.cn", "reply_time"));
				...
				try {
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setCallMdn(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setMdn(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setReply_time(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
	...
	public static class ReportResponse implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "ReportResponse", "ns1");
	...
	public static class ReplyResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "ReplyResponse", "ns1");
		...
		/**
		 * field for Replys This was an Array!
		 */
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":ReplyResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ReplyResponse", xmlWriter);
				}
			...
			if (localConfirm_timeTracker) {
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter.writeStartElement(prefix, "confirm_time",
								namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
				...
				if (localReplys != null) {
					...
					if (!namespace2.equals("")) {
						...
						if (prefix2 == null) {
							...
							xmlWriter.writeStartElement(prefix2, "replys",
									namespace2);
			...
			if (localReplysTracker) {
				if (localReplys != null) {
					for (int i = 0; i < localReplys.length; i++) {
						...
						if (localReplys[i] != null) {
							elementList.add(new javax.xml.namespace.QName(
									"http://ws.flaginfo.com.cn", "replys"));
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ReplyResponse parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"ReplyResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ReplyResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object.setConfirm_time(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
					...
					if (reader.isStartElement()
						...
						object.setReplys((Reply[]) org.apache.axis2.databinding.utils.ConverterUtil
								.convertToArray(Reply.class, list4));
	...
	private org.apache.axiom.om.OMElement toOM(
			SmsStub.ReplyConfirmRequest param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(
			SmsStub.ReplyConfirmResponse param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(SmsStub.AuditingRequest param,
	...
	private org.apache.axiom.om.OMElement toOM(SmsStub.AuditingResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(SmsStub.ReportResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(SmsStub.Sms param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
		...
		try {
			...
			emptyEnvelope.getBody().addChild(
					param.getOMElement(SmsStub.ReplyConfirmRequest.MY_QNAME,
							factory));
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
			org.apache.axiom.soap.SOAPFactory factory,
			SmsStub.AuditingRequest param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
		...
		try {
			...
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory
					.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(
					param.getOMElement(SmsStub.AuditingRequest.MY_QNAME,
							factory));
			return emptyEnvelope;
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
			org.apache.axiom.soap.SOAPFactory factory, SmsStub.Report param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
		...
		try {
			...
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory
					.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(
					param.getOMElement(SmsStub.Report.MY_QNAME, factory));
			return emptyEnvelope;
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
			org.apache.axiom.soap.SOAPFactory factory,
			SmsStub.ReplyRequest param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
		...
		try {
			...
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory
					.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(
					param.getOMElement(SmsStub.ReplyRequest.MY_QNAME, factory));
			return emptyEnvelope;
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
			org.apache.axiom.soap.SOAPFactory factory, SmsStub.Sms param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
		...
		try {
			...
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory
					.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(
					param.getOMElement(SmsStub.Sms.MY_QNAME, factory));
			return emptyEnvelope;
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
