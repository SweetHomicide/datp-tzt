...
public class AcpBase {
	...
	//测试
//	public static String merId="777290058140778";
//	public static String merId="802110048160925";//生产商户号（极为重要）//802110048160913
	public static String merId=Comm.getMERID();//生产商户号（极为重要）//802110048160913
	//802110048160925
	
	//后台服务对应的写法参照 FrontRcvResponse.java
//	public static String frontUrl = "http://124.207.214.130:7000/account/FrontRcvResponse.html";
	public static String frontUrl = Comm.getFRONTURL();

	//后台服务对应的写法参照 BackRcvResponse.java
//	public static String backUrl = "http://124.207.214.130:7000/account/BackRcvResponse.html";//受理方和发卡方自选填写的域[O]--后台通知地址
	public static String backUrl = Comm.getBACKURL();//受理方和发卡方自选填写的域[O]--后台通知地址
