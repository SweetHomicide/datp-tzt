...
public class BTCUtils {
	 ...
	 * **/
	public BTCInfo gettransactionValue(String xid,String category) throws Exception {
	...
	public String sendtoaddressValue(String address,double account,String comment) throws Exception {
		String result = "";
	...
	public static void main(String args[]) throws Exception{
		System.out.println(new Timestamp(1394024034394L));
	}
