...
//用户理财收益日志表
@Entity
public class ProfitLogRead implements java.io.Serializable {
	...
	@Column(name = "fproportion", precision = 4, scale = 4)
	...
	public ProfitLogRead(String fid, String ffinaWalletid, double famount, double fproportion, String fcreateTime,
