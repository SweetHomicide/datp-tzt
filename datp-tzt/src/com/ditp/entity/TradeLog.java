...
public class TradeLog implements java.io.Serializable {
	...
	private String ftype;//交易类型 取出,提现
	...
	public TradeLog(String fid, String ffinaId, String fuserId, double famount, String ftype, String fcreateTime,
